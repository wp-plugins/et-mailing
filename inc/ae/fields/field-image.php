        ...
        function render ()
        {
            ...
            <div class="customization-info" id="<?php echo $this->field['name']; ?> ">
                <div class="input-file upload-logo" id="<?php echo $uploaderID; ?>_container"
                     data-id="<?php echo $uploaderID; ?>" data-w="<?php echo $size[0] ?>"
                     data-h="<?php echo $size[1] ?>">
                    <div class="left clearfix">
                        <div class="image" id="<?php echo $uploaderID; ?>_thumbnail"
                             style="<?php echo 'width:'.$size[0].'px; height:'.$size[1].'px; text-align:center;'; ?> ">
                            <img style="max-height: <?php echo $size[1] ?>px;"
                                 src="<?php echo $this->value['thumbnail'][0] ?>"/>
                        </div>
                    </div>
